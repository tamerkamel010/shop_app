...
import 'package:shop_app/modules/shop_layout/view/screens/category_products_screen.dart';
      ...
      builder: (BuildContext context, Orientation orientation, DeviceType deviceType)=>BlocConsumer<ShopLayoutCubit,ShopLayoutStates>(
        ...
        builder: (BuildContext context, state){
            ...
            return Padding(
                ...
                child: ListView.separated(itemBuilder: (BuildContext context,int index)=>categoryItem(cubit.categoryModel.data.data[index],context),
...
Widget categoryItem(CategoryDataModel model,context){
  return InkWell(
    onTap: (){
      ShopLayoutCubit.get(context).getCategoryProducts(model.id);
      ShopLayoutCubit.get(context).navigateTo(context,CategoryProductsScreen(categoryName: model.name,categoryImage:model.image ,));
      },
    child: Row(
      children: [
        Container(
